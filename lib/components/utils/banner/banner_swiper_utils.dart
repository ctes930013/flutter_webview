...
class BannerSwiperUtils extends StatefulWidget {
  ...
  BannerSwiperUtils({Key? key, required this.length, this.getwidget, required this.width, required this.height, this.selectorWidget, this.normalWidget,this.autoLoop=true,this.showIndicator=true,this.spaceMode=true});
