...
class GifUtils extends StatefulWidget {
  final int frameRate;
  ...
  @override
  _GifUtilsState createState() => _GifUtilsState();
}

class _GifUtilsState extends State<GifUtils> with TickerProviderStateMixin {
